...
void naming(char* sysname, char* txt, double K, double iptmig_fac, double e_ini, double Qfac, double k2val, int tide_force){
    ...
    strcat(txt, str);
    char strQfac[15];
    sprintf(strQfac, "%.2f", Qfac);
    strcat(txt, strQfac);
    char* strk2 = "_k2";
    strcat(txt, strk2);
    char strk22[15];
    sprintf(strk22, "%.2f", k2val);
    strcat(txt, strk22);
    if(tide_force == 1){
