...
for i in xrange(0,N_files):
    ...
    if arg2 == 1:
        ...
        for k in xrange(1,N):
            ...
            for j in xrange(0,k):
                q=data[j::N]
                ratio = p[-1,3]/q[-1,3] - 2.  #check last elements for resonance
                if(ratio < 0.05 and ratio > 0.0):
                    ...
                    plt.scatter(out[:,arg1], yval, c=gradient, cmap=cm.coolwarm, vmin=0, vmax=1, lw=0)
                    print 'completed object',i+1,' of ',N_files
